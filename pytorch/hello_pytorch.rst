...
以降、https://github.com/miyakz1192/game_ad_automation.gitの
ssd.rstに記事を集約。

トライ4準備
=================

最近、学習用の画像の管理について煩雑になってきており、忘れそうなのでどこかにメモをしてまとめておく。
...
何か結果が変わるかを観察する。うまく行っても行かなくても、このプログラムにおいて学習データがどのように扱われているかの解析理解は必須なのでそこを重点的に取り組む。  
